...
class HandoffDocxCore:
    ...
    The handoff core can synthesize prose from ``report_model``.  AutoReport's
    ...
    def _load(self) -> ModuleType:
        ...
        spec = importlib.util.spec_from_file_location(f"autoreport_handoff_docx_{digest}", self.source_path)
