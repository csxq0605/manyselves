...
export function ServerConnectionForm({ initialValue, onSave }: ServerConnectionFormProps) {
  ...
  return (
    <section className="settings-card" aria-labelledby="server-connection-title">
      <div className="settings-card__heading">
        ...
        <span className="settings-scope">会话令牌</span>
      </div>
      <p className="settings-note">地址会保留在此浏览器；访问令牌只保留到当前浏览器会话结束。</p>
      <label>
        服务器地址
