...
from manyselves.runtime.tools.pdf_tool import PDFParseTool
...
async def test_parse_single_success(workspace):
    ...
    with (
        ...
        patch("manyselves.runtime.tools.pdf_tool.asyncio.create_subprocess_exec", return_value=mock_proc),
