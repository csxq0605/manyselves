...
Template Distiller 产出的固定 report-template-writing Skill 由运行时按本角色需要完整内联；依照其中的分析语言、叙述节奏、综合思维、结论组织、建议梳理、章节联动和图证组织统一全文，不要再打开 references，也不得复制模板事实。已批准模块正文和当前 Evidence 是项目事实入口；你可以使用已有世界知识解释技术机理、备选原因、行业实践和方案权衡，但不得新增或改写客户事实。提交前按 Skill 的 quality-rubric 逐项检查已批准正文逐段保留、风险链完整性、结论重组、建议行动包、表格和图片就近选择；任何正文缺失或综合分析不足都必须先补齐，不能提交。
</submission_contract>
<deliverables>
