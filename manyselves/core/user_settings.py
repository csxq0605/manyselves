"""Repository-local user settings persistence service."""
...
class UserSettings:
    """Manage preferences stored under the repository-local ``.manyselves`` directory."""

    STORAGE_FILE = REPOSITORY_ROOT / ".manyselves" / "user_settings.json"
