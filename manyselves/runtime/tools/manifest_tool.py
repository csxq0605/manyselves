...
IGNORED_DIRS = {".git", "__pycache__", ".manyselves", ".checkpoints"}

AGENT_DIRECTORIES = {
    "main": ["Inputs", "Knowledge", "Templates", "Work", "Outputs"],
}
...
class ManifestManager:
    ...
    def __init__(self, workspace: Path):
        ...
        self.base_dir = self.workspace / ".manyselves" / "manifests"
...
class ManifestTool(Tool):
    ...
    The active runtime has one user-facing Main manifest.
    """

    name = "manifest"
    description = (
        "Read or update the Main project manifest. "
        "Use it to inspect available project files, "
    ...
    async def __call__(
        ...
        Args:
            ...
            agent: Optional agent identifier for reads. Only ``main`` is valid.
