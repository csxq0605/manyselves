...
- HEAD at slice start: `d338e68 Runtime: drive natural agent recovery turns`
...
| Reporting Python 归 Capability 所有 | Module Lane/Cohort 与 Cross Owner 的 8 个 Contract 类型已真正迁入 Capability；其余领域模型、Agent runner、review/render/delivery 仍在 `manyselves/core/reporting` | 物理和语义归属仍部分混合 | FA-03/FA-05 继续分类迁移 |
